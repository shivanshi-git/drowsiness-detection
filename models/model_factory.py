...
from .eye_model import EyeStateModel
from .face_model import FaceDrowsinessModel
...
def get_model(model_name='vgg16', num_classes=2, pretrained=True):
    ...
    elif model_name == 'eye_resnet18':
        model = EyeStateModel(num_classes=num_classes, pretrained=pretrained)
        target_layer = model.target_layer
    elif model_name == 'face_resnet18':
        model = FaceDrowsinessModel(num_classes=num_classes, pretrained=pretrained)
        target_layer = model.target_layer
